...
public class RegistrarCarroClienteHttp {
    private String url;
    private String path;
    ...
    public RegistrarCarroClienteHttp() {
    ...
    public void createCarro(VehicleResource vehicleResource) throws IOException {
        Gson gson = new Gson();
        this.carros.add(gson.toJson(vehicleResource, VehicleResource.class));
    }
    ...
    public void make() throws IOException {
        ...
        for (int i = 0; i < this.carros.size(); i++) {
            RequestBody body = RequestBody.create(this.carros.get(i), mediaType);
