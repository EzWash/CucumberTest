...
public class EditarTrabajadorCarWashHttp {
        private String url;
        private String path;
        ...
        public EditarTrabajadorCarWashHttp() {
        ...
        public void updateTrabajadorData(StaffResource staffResource) throws IOException {
                Gson gson = new Gson();
                this.services.add(gson.toJson(staffResource, StaffResource.class));
        }
